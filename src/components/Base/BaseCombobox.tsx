...
const BaseCombobox = ({ options, placeholder, onChange, onInputChange, onKeyPress, isLocation, isSize }) => {
    ...
    return (
        <>
            {!isSize && <Combobox as="div" onChange={handleSelectOption} value={selectedOption}>
            ...
            {isSize &&
                <Combobox as="div" value={selectedOption} onChange={handleSelectOption}>
                    <div className="relative">
                        <Combobox.Input
